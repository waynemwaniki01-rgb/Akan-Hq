...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BmBASHQL.mjs");
...
var manifest = { "0b515ba27a8a66b3a1aeacb237af916385778b20904e91e04e00a9421afaddd9": {
	functionName: "generateCardAesthetics_createServerFn_handler",
	importer: () => import("./card-ai-CuAVjcZz.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Bu3nZ6EP.mjs").then((n) => n.t),
